...
import com.example.algamoney.api.dto.LancamentoTesouraria;
...
//-----------------------------------------------------------------------RELATÓRIO TESOURARIA
	@Override
	public List<LancamentoTesouraria> porTesoura(LocalDate inicio, LocalDate fim) {
		CriteriaBuilder criteriaBuilder = manager.getCriteriaBuilder();
			
		CriteriaQuery<LancamentoTesouraria> criteriaQuery = criteriaBuilder
				.createQuery(LancamentoTesouraria.class);
		
		Root<Lancamento> root = criteriaQuery.from(Lancamento.class);
			
		criteriaQuery.select(criteriaBuilder.construct(LancamentoTesouraria.class,				
				root.get(Lancamento_.tipo),
				root.get(Lancamento_.dataVencimento),
		...
		TypedQuery<LancamentoTesouraria> typedQuery = manager.createQuery(criteriaQuery);		
